    ...
    <div className="p-4 sm:p-6 md:p-8 bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center mb-8">
        <nav className="flex flex-col items-start justify-between p-4 z-10">
          <h1 className="text-xl sm:text-2xl font-bold">Euphonic Dashboard</h1>
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link href="/main">
            <RainbowButton className="p-2 text-sm sm:text-base">
              Begin Session
            </RainbowButton>
          </Link>
        </div>
      ...
      <div className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-7 mt-6 sm:mt-8">
        <Card className="col-span-1 lg:col-span-4 bg-white shadow-lg">
          <CardHeader>
            <CardTitle className="text-lg sm:text-xl text-gray-800">
        ...
        <Card className="col-span-1 lg:col-span-3 bg-white shadow-lg">
          <CardHeader>
            <CardTitle className="text-lg sm:text-xl text-gray-800">
              Topics Discussed
            </CardTitle>
