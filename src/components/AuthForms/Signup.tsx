              ...
              <form noValidate onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="space-y-1">
                    ...
                    type="password"
                    placeholder="Password"
                    className="h-[52px] bg-[#4342B9] border-0 rounded-[14px] text-white placeholder:text-white/60 px-4"
                  />
                    ...
                    <div className="space-y-2">
                      <div className="relative">
                        <Input
                          ...
                          name="confirmPassword"
                          autoComplete="new-password"
                          className={`w-full pr-10 h-[52px] bg-[#4342B9] border-0 border-white rounded-[14px] text-white placeholder:text-white/60 px-4${
                            confirmPasswordError ? "border-red-500" : ""
                          }`}
                          value={confirmPassword}
                          onChange={(e) => {
